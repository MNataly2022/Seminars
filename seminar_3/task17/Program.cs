...
// причём X ≠ 0 и Y ≠ 0 и выдаёт номер четверти плоскости, в которой находится эта точка.
 ...
 Console.WriteLine("Введите координату точки по ост X");
 int x = Convert.ToInt32(Console.ReadLine());

 Console.WriteLine("Введите координату точки по ост Y");
...
{
    Console.WriteLine("Ведена нулевая координата по оси X и/или по оси Y"); 
}
